...
Iterator::Iterator(ParticlesDistribution* set, Flow* f)
{
	...
	param_evolution = new ParametersEvolution("./flows/alessandroFlow/iterator/turns","./flows/alessandroFlow/iterator/kick");
	readParameters();
...
Iterator::readParameters()
{
    ...
    if(dimensions == TWO_DIMENSIONS || dimensions == FOUR_DIMENSIONS || dimensions == SIX_DIMENSIONS)
    {
        ...
        file_name = XMLInputParser::getInstance().getAttributeTextFromPath("./flows/alessandroFlow/iterator", "file");
