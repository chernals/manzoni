...
ProcDistrProfile::ProcDistrProfile(ParticlesSet* part_set, std::string xpath) : 
    xpath_(xpath)
{        
...
ProcDistrProfile::readParameters()
{
    ...
    box_size_ = XMLInputParser::getInstance().getFirstTextd("./flows/alessandroFlow/windowSize");
