...
ParticlesSet::ParticlesSet()
{
    ...
    if(distr_type != "gaussian" && distr_type != "uniform" && distr_type != "file")
    {
...
ParticlesSet::setTracking()
{
    ...
    if(XMLInputParser::getInstance().isFoundFromPath("./flows/henonFlow/initialDistribution/tracking"))
    {
        ...
        // Coherence check
        int n_x = XMLInputParser::getInstance().howManyFoundFromPath("./flows/henonFlow/initialDistribution/tracking/particle/X");
        int n_xp = XMLInputParser::getInstance().howManyFoundFromPath("./flows/henonFlow/initialDistribution/tracking/particle/XP");
...
ParticlesSet::readParameters()
{
    ...
    if(distr_type == "gaussian")
    {
        ...
        if(distr_dims == 2 || distr_dims == 4 || distr_dims == 6)
        {
            ...
            _gaussian_hor_density = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/horizontal/density");
        }
        if(distr_dims == 4 || distr_dims == 6)
        {
            ...
            _gaussian_ver_density = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/vertical/density");
        }
        if(distr_dims == 6)
        {
            ...
            _gaussian_long_density = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/longitudinal/density");
        }
    }
    else if(distr_type == "uniform")
    {
        ...
        if(distr_dims == 2 || distr_dims == 4 || distr_dims == 6)
        {
            ...
            _radial_density_horizontal = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/horizontal/radialDensity");
            _angular_density_horizontal = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/horizontal/angularDensity");
        }
        if(distr_dims == 4 || distr_dims == 6)
        {
            ...
            _radial_density_vertical = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/vertical/radialDensity");
            _angular_density_vertical = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/vertical/angularDensity");
        }
        if(distr_dims == 6)
        {
            ...
            _radial_density_longitudinal = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/longitudinal/radialDensity");
            _angular_density_longitudinal = XMLInputParser::getInstance().getFirstTexti("./flows/henonFlow/initialDistribution/longitudinal/angularDensity");
        }
    }
		else if(distr_type == "file")
		{
...
ParticlesSet::computeDerivedParameters()
{
    ...
    else if(distr_type == "uniform")
    {
        ...
        if(distr_dims == 4)
        {
            ...
            _radial_increment_horizontal = _radius_limit_horizontal / (_radial_density_horizontal);
            _angular_increment_horizontal = 2*M_PI/(_angular_density_horizontal);           
 						_radial_increment_vertical = _radius_limit_vertical / (_radial_density_vertical);
            _angular_increment_vertical = 2*M_PI/(_angular_density_vertical);
        }
        if(distr_dims == 6)
        {
