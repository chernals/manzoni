...
void Pendulum::integrate(double& PHI, double& J,std::vector<double> params, int t, int iter,int)
{
...
double Pendulum::getEnergy(double PHI, double J, std::vector<double> params, int, int, int)
{
	return ((0.5 * (J-params.at(1)) * (J-params.at(1))) - (params.at(0) * (1+params.at(2)) * cos(PHI)));
}

void Pendulum::integrate1(double& PHI, double& J,std::vector<double> params, int, int)
{
	// params.at(0) === AK
	// params.at(1) === DELTA
	// params.at(2) === BETA
...
void Pendulum::integrate2(double& PHI, double& J,std::vector<double> params, int, int)
{
	// params.at(0) === AK
	// params.at(1) === DELTA
	// params.at(2) === BETA
...
void Pendulum::integrate3(double& PHI, double& J,std::vector<double> params, int, int)
{
	// params.at(0) === AK
	// params.at(1) === DELTA
	// params.at(2) === BETA
...
void Pendulum::integrate4(double& PHI, double& J,std::vector<double> params, int, int)
{
	// params.at(0) === AK
	// params.at(1) === DELTA
	// params.at(2) === BETA
	for(int o=1;o <= 4; o++)
	{
		 	J   = J    - coef_b[o-1] * params.at(0) * (1+params.at(2)) * sin(PHI);
     	PHI = PHI  + coef_a[o-1] * (J-params.at(1));
	}
}
